        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(Nome)
                    .addComponent(jTxtApelido, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(102, 102, 102)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
...
ArrayList lista;
        ...
        if (jTxtApelido.getText().trim().equals("") && jCboAtivo.isSelected() == false){
         lista = (ArrayList) usuarioDAO.listAll();
         pesquisarUsuario.setList(lista);
        } else {
            if(!jTxtApelido.getText().equals("") && jCboAtivo.isSelected() == true){
               lista = (ArrayList)  usuarioDAO.listApelidoAtivo( jTxtApelido.getText(), jCboAtivo.isSelected());
               pesquisarUsuario.setList(lista);
              
            }else {
                if(!jTxtApelido.getText().trim().equals("")){
                    lista = (ArrayList) usuarioDAO.listApelido(jTxtApelido.getText());
                     pesquisarUsuario.setList(lista);
                } else{
                    if(!jCboAtivo.getText().trim().equals("")){
                        lista = (ArrayList) usuarioDAO.listAtivo(jCboAtivo.isSelected());
                     pesquisarUsuario.setList(lista); 
                    }
                }
            }}
